...
import { fetchMessagesOnScrollUp, getPlaceholderTemplate, fetchMessagesOnClick, fetchMessagesOnScrollDown } from './utils.js';
...
converse.plugins.add('converse-mam-views', {
    ...
    initialize () {
        ...
        api.listen.on('chatBoxScrolledDown', fetchMessagesOnScrollDown);
